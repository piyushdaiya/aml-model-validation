...
function TestingWorkspacePanel({
  workspace,
}: {
  workspace: TestingWorkspace
}) {
  const chartsReady = useHydrated()
  const scenarios = useMemo(() => workspace.scenarios, [workspace.scenarios])
  ...
  return (
    <div className="space-y-6">
      <SectionCard
        ...
        description="Believable sensitivity, stress, adversarial, ATL, and BTL scenarios prepared for leadership demos and future test orchestration."
    ...
    <div className="space-y-6">
      ...
      >
        <div className="max-w-[320px]">
          <p className="mb-2 text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">Model</p>
      ...
      {workspace ? <TestingWorkspacePanel key={workspace.modelId} workspace={workspace} /> : null}
    </div>
  )
}
...
export default function TestingPage() {
  return (
    <DemoShell
      title="Testing Lab"
      description="Scenario-driven testing surface for consulting teams to simulate thresholds, communicate rigor, and show how this demo becomes a full validation workbench."
